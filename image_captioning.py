...
prompt = (
    ...
    "Also, the output of your message should only include the 1 paragraph that is going to be used as the caption of the image, so no talking, no thinking, no explaining your thought process, just on long and detailed paragraph about the image"
)
